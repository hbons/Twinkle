...
fn test_pretty_commit_message() {
    ...
    assert_eq!(format_commit_message(&empty_status), None);
...
#[test]
fn test_pretty_commit_message_renamed() {
    let empty_status = vec![];
    assert_eq!(format_commit_message(&empty_status), None);
    ...
    assert_eq!(format_commit_message(&status), Some("+1, −1".to_string()));
}


#[test]
fn test_pretty_commit_message_copied() {
    let empty_status = vec![];
    assert_eq!(format_commit_message(&empty_status), None);
...
#[test]
fn test_pretty_commit_message_multiple() {
    let status = vec![
        GitChange {
            status_x: Some(GitFileStatus::Added),
            status_y: None,
    ...
    assert_eq!(format_commit_message(&status), Some("+2".to_string()));
}


#[test]
fn test_pretty_commit_message_various_2() {
    let status = vec![
        GitChange {
            status_x: Some(GitFileStatus::Added),
            status_y: None,
...
#[test]
fn test_pretty_commit_message_various_3() {
    let status = vec![
        GitChange {
            status_x: Some(GitFileStatus::Added),
            status_y: None,
    ...
    assert_eq!(format_commit_message(&status), Some("+1, ~1, −1".to_string()));
}
